...
namespace MyFinance.Models
{
    public class ContaModel
    {
        ...
        //Recebe o contexto para acesso às variaveis de sessão.
        ...
        public void Selecionar(int id_conta)
        {
            new DAL().ExecutarComandoSQL("SELECT ID FROM CONTA WHERE ID = " + id_conta);
        }
